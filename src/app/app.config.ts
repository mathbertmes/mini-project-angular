...
export const appConfig: ApplicationConfig = {
  providers: [provideZoneChangeDetection({ eventCoalescing: true }), provideRouter(routes), provideAnimationsAsync(), provideFirebaseApp(() => initializeApp({"projectId":"angular-mini-project-95a4d","appId":"1:798392887270:web:8c7de6ccc4c4fe0a481827","storageBucket":"angular-mini-project-95a4d.appspot.com","apiKey":"AIzaSyCrXTmkzpSxxZ22eco_4LDtvP2LyU348OQ","authDomain":"angular-mini-project-95a4d.firebaseapp.com","messagingSenderId":"798392887270","measurementId":"G-3QY5HSYWFK"})), provideAuth(() => getAuth()), provideFirestore(() => getFirestore()), provideHttpClient()]
};
